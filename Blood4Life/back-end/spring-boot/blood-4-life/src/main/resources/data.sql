...
insert into hospital (id_hospital, nome, email, senha, cnpj, cidade, rua, bairro, cep, complemento, uf, telefone) values
(1, 'Albert Einstein', 'albert@einstein.com', 'senha123', '60765823000130', 'São Paulo', 'R. Albert Einstein', 'Jardim Leonor', '05652000', 'Palácio dos Bandeirantes','SP', '1121511233'),
(2, 'Santa Casa', 'santa@casa.com', 'senha123','10003060765823', 'São Paulo', 'R. Jardim São Francisco', 'Alexandre Artrot', '02056500', '','SP', '1115112332');
